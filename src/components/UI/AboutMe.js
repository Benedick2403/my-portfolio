...
export default function AboutMe (){
    return(
        ...
        <div className="flex flex-col justify-between w-full h-full max-h-full mb-5 lg:w-1/2 lg:mb-0">
            <div>
                <h1 className="md:text-5xl text-3xl font-semibold">Benedick M. Mercado</h1>
                <h3 className="md:text-lg sm:text-sm mt-1 mb-3 text-gray-800">Game Developer | FrontEnd</h3>
            </div>

            <div className="flex flex-col justify-between w-full h-full max-h-full gap-4 md:text-base sm:text-sm [&_b]:text-red-300 text-gray-600">
